...
form.addEventListener("submit",async(e)=>{
    ...
    let vsrc=document.querySelector("video")
        switch(descriptiondata){
            case "ash":
                ...
                vsrc.src="./assets/backgroundvideos/ash.mp4"
                break;
            case "clear":
                ...
                // walli.style.backgroundSize="cover"
                vsrc.src="./assets/backgroundvideos/clear.mp4"
                break;
            case "clouds":
                ...
                // walli.style.backgroundSize="cover"
                vsrc.src="./assets/backgroundvideos/cloudy.mp4"
            ...
            case "drizzle":
                ...
                // walli.style.backgroundSize="cover"
                vsrc.src="./assets/backgroundvideos/drizzle.mp4"
                break;
            case "dust":
                ...
                // walli.style.backgroundSize="cover"
                vsrc.src="./assets/backgroundvideos/dust.mp4"
                break;
            case "fog":
                ...
                //  walli.style.backgroundSize="cover"
                vsrc.src="./assets/backgroundvideos/mist.mp4"
                break;
            case "haze":
                ...
                // walli.style.backgroundSize="cover"
                vsrc.src="./assets/backgroundvideos/haze.mp4"
                break;
            case "mist":
            ...
            case "rain":
                ...
                // walli.style.backgroundSize="cover"
                vsrc.src="./assets/backgroundvideos/rain.mp4"
                break;
            case "sand":
            ...
            case "smoke":
                ...
                //  walli.style.backgroundSize="cover"
                vsrc.src="./assets/backgroundvideos/smoke.mp4"
                break;
            case "snow":
            ...
            //    walli.style.background="url(./assets/backgrounds/snow.gif)"
                // walli.style.backgroundSize="cover"
                vsrc.src="./assets/backgroundvideos/snow.mp4"
               break;
            case "squall":
            ...
            case "thunderstorm":
                ...
                imageofcard.style.width="150px"
                vsrc.src="./assets/backgroundvideos/thunderstorm.mp4"
                break;
            case "tornado":
                ...
                imageofcard.style.width="150px"
                // walli.style.backgroundSize="cover"
                vsrc.src="./assets/backgroundvideos/tornado.mp4"
                break;
            default:
